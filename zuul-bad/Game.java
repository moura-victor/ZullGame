...
public class Game 
{
    ...
    private void createRooms()
    {
        ...
        center.setExits(foodPark, store, bank, movieTheather);
        foodPark.setExits(null, parkingLot, center, null);
        movieTheather.setExits(null, center, null, null);
        bank.setExits(center, null, null, null);
        store.setExits(parkingLot, null, null, center);
        parkingLot.setExits(exit, null, store, foodPark);
        exit.setExits(null, null, parkingLot, null);
